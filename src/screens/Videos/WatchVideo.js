...
const WatchVideo = () => {
    ...
    const { isFetching: recommendationFetching, videos: next } = useSelector(state => state.recommendation);
                ...
                <div className="channel-info-description">
                    <div className="channel-info-flex">
                        <div className="channel-info flex-row">
                            <img src={video.User?.avatar} className="avatar md" alt="channel avatar" />
                        ...
                        {!video.isVideoMine && video.isSubscribed && (
                            <Button onClick={() => handleUnsubscribe(video.User.id)}>
                                Subscribed
                            </Button>
                        )}
                    </div>
