...
import ChannelTabAbout from 'components/channels/ChannelTabAbout';
import ChannelTabVideo from 'components/channels/ChannelTabVideo';
import ChannelTabChannels from 'components/channels/ChannelTabChannel';
            ...
            <div className="header-tabs">
                <div className="header">
                    <div className="flex-row">
                        <img src={profile.avatar} alt="channel avatar" className="avatar lg" />
                        <div>
